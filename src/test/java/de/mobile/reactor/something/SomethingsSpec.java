...
public class SomethingsSpec {
  ...
  public void shouldBlockAndFailToLoadSomething() throws Exception {
    assertThatThrownBy(() -> sut.loadById(5)).isEqualTo(new SomethingsImpl.SomethingNotFoundException(5));
  }
  ...
  public void shouldNotBlockAndFailToLoadSomething() throws Exception {
    ...
    assertThat(callback.error).isEqualTo(new SomethingsImpl.SomethingNotFoundException(5));
